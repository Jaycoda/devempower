  ...
  return (
    <div className="bg-white rounded-lg mx-4 p-4">
      ...
      <form onSubmit={handleSubmitForm} className="flex flex-col max-w-[500px]">
        ...
        />
        {errors.name !== "" && (
          <span className="text-white bg-red-500 p-1">{errors.name}</span>
        )}
        ...
        />
        {errors.email !== "" && (
          <span className="text-white bg-red-500 p-1">{errors.email}</span>
        )}
        ...
        />
        {errors.phone !== "" && (
          <span className="text-white bg-red-500 p-1">{errors.phone}</span>
        )}
        ...
        />
        {errors.password !== "" && (
          <span className="text-white bg-red-500 p-1">{errors.password}</span>
        )}

        <button
          type="submit"
          className="bg-green-700 text-white rounded-lg p-2 my-2"
        >
          Send To Backend
        </button>
      </form>
