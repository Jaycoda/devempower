...
const RHFYupPage = () => {
  const schema = yup.object().shape({
    ...
    email: yup.string().required().email("Not valid email"),
    phone: yup.number().required().min(11).max(15),
    password: yup
      .string()
      .required()
      .min(3)
      .notOneOf(["111", "aaa"], "Not valid password"),
  });
  ...
  return (
    <div className="bg-white rounded-lg mx-4 p-4">
      ...
      <form
        onSubmit={handleSubmit(callBackFunctionTest)}
